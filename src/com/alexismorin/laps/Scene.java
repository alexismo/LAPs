...
public class Scene {
	...
	void drawTiles() {
		...
		for (int i = 0; i < board.words.size(); i++) {
			...
			parent.fill(0);
			parent.text(w.getWord(), w.pos.x + 10, w.pos.y + Config.wordSize/ 2);
		...
		parent.text(board.getSentenceString(), 
				parent.width / 2,
				parent.height - 100);
	}
	...
	void drawBezier(Word w1, Word w2){
		...
		parent.noFill();
		parent.bezier(w1.pos.x+Config.wordSize/2, w1.pos.y+Config.wordSize/2, 
				w1.pos.x+Config.wordSize/2, w1.pos.y-Config.wordSize, 
				w2.pos.x+Config.wordSize/2, w2.pos.y-Config.wordSize, 
				w2.pos.x+Config.wordSize/2, w2.pos.y+Config.wordSize/2
				);
	}
